...
import { clerkConfig } from "@/config/env";
...
export default function SignInPage() {
  return (
    <Container className="grid w-full flex-grow items-center bg-white px-4 sm:justify-center">
      <SignIn.Root>
        <SignIn.Step
          name="start"
        ...
        >
          ...
          <p className="text-center text-sm text-neutral-500">
            ...
            <Link
              href={String(clerkConfig.auth.signUp!)}
